...
if programRequest == "12":
    ...
    print("Invalid input. Please try again with the numbers 1-12. If there is a bug, please report it to the developer at \x1b]8;;http://github.com/44H4/WinGet-Installer/issues/'\x1b\\Ctrl+Click here to the GitHub page\x1b]8;;\x1b\\.")